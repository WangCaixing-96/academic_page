...
- <strong>Caixing Wang</strong>, Xingdong Feng (2024), spotlight. Optimal kernel quantile learning with random features. <strong>International Conference on Machine Learning (ICML)</strong>.  [[Paper]](https://openreview.net/pdf?id=KOW9ncAiRo)
